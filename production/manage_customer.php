		...
		<div class="table-wrapper">
			<div class="table-title">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="add_medicine.php" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add Medicine</span></a>
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					...
					<td>
						<?php echo $result['cus_pnumber']; ?>
					</td>
					<td>
						<?php echo $result['cus_id']; ?>
					</td>
					<td>
						<?php echo $result['cus_t_amount']; ?>
					</td>
					<td>
					<?php echo $result['cus_email']; ?>
					</td>
					<td>
					<?php echo $result['cus_address']; ?>
					</td>
					<td>
					<?php echo $result['reguler_discount']; ?>
					</td>
					<td>
					<?php echo $result['cus_note']; ?>
					</td>
					<td>
					<a href="edit_customer.php?ids=<?php echo $result['c_id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
