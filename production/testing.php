                                        ...
                                        <tbody>
                                               ...
                                               <tr> 
                                                ...
                                                <td>
                                                    ...
                                                    <!-- assets/images/capsules.png" alt="" height="25" class="img-rounded image_rounded"> -->
                                                    <?php }else{?>
                                                    <!-- assets/images/medicine/<?php echo $value->product_image ?>" alt="" height="25" class="img-rounded image_rounded"> -->
                                                    <?php }?>
                                                </td>
                                            </tr>
