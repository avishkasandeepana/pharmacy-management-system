		...
		<a href="generate_pdf.php" class="btn btn-primary">Download PDF</a>
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					...
					<td>
						<?php echo $result['strength']; ?>
					</td>
					<td>
						<?php echo $result['form']; ?>
					</td>
					<td>
					<?php echo $result['trade_price']; ?>
					</td>
					<td>
					<?php echo $result['expire_date']; ?>
					</td>
					
					<td>
					<?php echo $result['side_effect']; ?>
					</td>
					<td>
					...
					<td>
					<a href="edit_medicine.php?id=<?php echo $result['med_id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
...
if (isset($_POST['delete'])){
	include 'conn.php';
$id = $medid;
$delete = "DELETE FROM medicine WHERE med_id = $id";
